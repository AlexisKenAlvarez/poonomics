...
const Nav = () => {
    ...
    const list = ['home', 'about', 'features', 'tokenomics', 'roadmap']
    ...
    return (
        <>
            <motion.nav initial={{ opacity: 0 }} animate={{ opacity: 100 }} transition={{ duration: 0.7 }} className={`w-full h-auto lg:h-auto sm:px-10 px-3 sm:py-5 text-white z-[30] top-0 left-0 fixed ${scrolled ? "bg-hero py-3 border-b-[1px] border-b-mypink/[.20]" : ""}`}>
